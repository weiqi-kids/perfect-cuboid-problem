\\ Extend rank survey from m=120 to m=150.
default(parisize, 800000000);
print("=== rank survey 120 < m <= 150 ===");
...
for(m=121, 150, for(n=1, m-1, work(m, n)); if(m%5==0, print("  m=", m, " done total=", total, " elapsed=", (getwalltime()-t0)/1000.0, "s")));

print("\nTotal m in (120,150]: ", total);
