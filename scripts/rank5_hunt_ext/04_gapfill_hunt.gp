\\ Gap-fill hunt: ellrank(Emin, 3) on every gapfill sieve survivor
default(parisize, 1200000000);

INFILE = "/root/proof/perfect-cuboid-problem/scripts/rank5_hunt_ext/gapfill_sieve.txt";
OUTFILE = "/root/proof/perfect-cuboid-problem/scripts/rank5_hunt_ext/gapfill_hunt.txt";
SURVFILE = "/root/proof/perfect-cuboid-problem/scripts/rank5_hunt_ext/gapfill_survivors.txt";
...
S = load_sieve(INFILE);
print("Loaded ", length(S), " gapfill candidates");
